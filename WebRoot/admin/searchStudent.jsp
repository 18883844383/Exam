...
<form action="" method="post" enctype="multipart/form-data" name="form1">
      <table width="50%"  height="150" border="1" align="center" cellspacing="0">
        ...
        <tr>
          <td>班级:
          <input type="text" name="class" id="class" height="20" width="150" readonly="readonly"/>
</td>
          <td>电话:
          <input type="text" name="TEL" id="TEL" height="20" width="150" readonly="readonly"/></td>
        </tr>
      </table>
